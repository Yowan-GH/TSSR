...
![Image](images/Environnement_MS_14.png)Il est indispensable de publier le partage dans l’AD afin de pouvoir le retrouver facilement
...
Pour les configurer  Clic droit / Définir une option
...
![Image](images/Environnement_MS_17.png) Répartition de la charge :
...
![Image](images/Environnement_MS_38.png)Le DNS (Domain Name System) est un système qui traduit les noms de domaine compréhensibles par les humains (comme exemple.com) en adresses IP compréhensibles par les machines (comme 192.168.1.1). Il agit comme un annuaire téléphonique d’Internet.

Le fichier hosts est un fichier système qui associe manuellement des noms de domaine à des adresses IP, sans passer par un serveur DNS. Il permet de rediriger des sites web localement sur un ordinateur.
...
Requête Récursive (Full Service DNS) ✅
...
Requête Itérative (Step by Step) 🔄
...
![Image](images/Environnement_MS_9.png)
...
Pour une zone directe : 						Pour une zone inverse
![Image](images/Environnement_MS_32.png)![Image](images/Environnement_MS_22.png)
...
## Configuration d’un DNS hébergeur
Création de zone de recherche direct et indirect avec un nom explicite.
En effet, le nslook fonctionnera avec : MACHINE.mazone.local
Faire un snapshot
Clic droit, ajouter nouvel hôte


## Les mises à jour et enregistrement dynamique
Utile pour les postes clients.

Le transfert de zone :
Le serveur secondaire interroge le serveur maitre
Comparaison avec le serveur principale
Transfert et mise à jour de zone.


Pour mettre à jour automatique le serveur DNS et incrémenter les nouveaux postes.
...
Pour créer une délégation de zone, clic droit sur la zone / nouvelle délégation / entrer le domaine délégué puis ajoutez l’ip du serveur DNS enfant.
